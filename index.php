...
<body>
    ...
    <div class="wrapper">
        ...
        <header id="navigation">
            ...
            <hr style="width: 98%; margin-bottom: 0;" />
            ...
            <hr style="width: 98%; margin-top: 0;" />
            ...
            <div class="leftcolumn">
                ...
                <?php
                    try {
                        ...
                        $stmt = $db->query('SELECT postID, postTitle, postDesc, postDate, postBy FROM blog_posts ORDER BY postID DESC');
                        while($row = $stmt->fetch()){
                            
                            echo '<div class="card mainblog">';
                                echo '<h1>'.$row['postTitle'].'</h1>';
                                echo '<h5>'.date('jS M Y', strtotime($row['postDate'])).' by <span>'.$row['postBy'].'</span></h5>';
                                echo '<p>'.$row['postDesc'].'</p>';             
                                echo '<p><a href="viewblog.php?id='.$row['postID'].'" class="continue-read">Continue Reading</a></p>';
                            echo '</div>';
                ...
                <div class="card button">
                    <a href="javascript:void(0)" class="older">Older</a><a href="javascript:void(0)" class="newer">Newer</a>
                </div>
